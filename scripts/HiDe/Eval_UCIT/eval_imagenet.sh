...
RESULT_DIR="/root/Desktop/code/HiDe/HiDe-LLaVA-main/output/UCIT/each_dataset/ImageNet-R"
...
CUDA_VISIBLE_DEVICES=$GPU python -m llava.eval.model_answer \
    ...
    --question_file /root/Desktop/code/CKM/CKM-LLaVA-main/instructions/ImageNet-R/test_3000.json \
...
python -m llava.eval.eval_deepseek_r1 \
    --annotation-file /root/Desktop/code/CKM/CKM-LLaVA-main/instructions/ImageNet-R/test_3000.json \
