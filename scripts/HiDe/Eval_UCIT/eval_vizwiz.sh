...
RESULT_DIR="/root/Desktop/code/HiDe/HiDe-LLaVA-main/output/UCIT/each_dataset/VizWiz"
...
CUDA_VISIBLE_DEVICES=$GPU python -m llava.eval.model_answer \
    ...
    --question_file /root/Desktop/code/CKM/CKM-LLaVA-main/instructions/VizWiz/test_3000.json \
...
python -m llava.eval.eval_vizwiz \
    --annotation_file /root/Desktop/code/CKM/CKM-LLaVA-main/instructions/VizWiz/test_3000.json \
